...
| FluidSynth    | >= 2.2.0  | Optional              | Runtime                | To play music based in MUS or MIDI format                                                                                                            |
| make          |           | Required              | Build time             | For autotools build system                                                                                                                           |
| man-db        |           | Optional              | Runtime                | To view documentation with `man psdoom-ng`                                                                                                           |
| libpng        | >= 1.2.50 | Optional              | Runtime                | To save screenshots in PNG format                                                                                                                    |
